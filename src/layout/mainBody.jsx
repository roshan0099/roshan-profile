                ...
                <div id="display-work">
                    <div className="cols">
                        <div className="col" id="1"    >
                            <h1>Easedementia</h1>
                            <a href="https://easedementia.com/"><img src="/github.png" alt="" height="90px" width="90px" /></a>
                           <p>
                        ...
                        <div className="col" id="2"    >
                            <h1> Confab</h1>
                            <a href="https://github.com/roshan0099/spaceWeb"><img src="/github.png" alt="" height="90px" width="90px" /></a>
                            <p>
                        ...
                        <div className="col" id="3"    >
                            <h1> Musik </h1>
                            <a href="https://github.com/roshan0099/musik-nodejs"><img src="/github.png" alt="" height="90px" width="90px" /></a>
                            <p>
                        ...
                        <div className="col" id = "4"    >
                            <h1> SpaceWeb</h1>
                            <a href="https://roshan0099.github.io/spaceWeb/"><img src="/github.png" alt="" height="90px" width="90px" /></a>
                            <p>
